export interface Announcement {
    ...
    description: string;
    date: string;
    category: 'datesheet' | 'result' | 'admission' | 'scholarship' | 'notice' | 'general';
    important: boolean;
}

export const announcements: Announcement[] = [
    { id: 1, title: 'Spring 2026 Mid-Term Date Sheet Released', description: 'The mid-term examination date sheet for Spring 2026 semester has been published. Check your VULMS portal for detailed schedule.', date: '2026-02-14', category: 'datesheet', important: true },

...
export const services: Service[] = [
    ...
    { id: 4, title: 'Complete LMS Handling', description: 'We handle your entire semester LMS activities', icon: '🎯', priceLocal: 'Rs. 1,200-1,500/subject', priceUSD: '$12-15/subject', features: ['All assignments', 'All quizzes', 'All GDBs', 'Result guarantee', '24/7 support'], popular: true },
    ...
    { id: 9, title: '24/7 Academic Support', description: 'Round-the-clock academic guidance and mentoring', icon: '🌟', priceLocal: 'Rs. 500/semester', priceUSD: '$5/semester', features: ['WhatsApp support', 'Study guidance', 'Career counseling', 'Exam strategies'], popular: false },
];

export const testimonials = [
    { name: 'Ahmed K.', program: 'BSCS', semester: '6th', text: 'HSM Tech helped me improve my GPA from 2.8 to 3.5! Their assignment quality is excellent.', rating: 5 },
    ...
    { name: 'Usman T.', program: 'MBA', semester: '2nd', text: 'Best academic support service for VU students. Their team is responsive and professional.', rating: 4 },
];

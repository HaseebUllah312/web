            ...
            <div className="container" style={{ maxWidth: '800px' }}>
                ...
                <div className="card" style={{ padding: '32px', lineHeight: '1.8', color: 'var(--text-secondary)' }}>
                    <p style={{ marginBottom: '24px' }}>
                        Welcome to VU Academic Hub. We respect your privacy and are committed to protecting your personal data. This Privacy Policy explains how we collect, use, and safeguard your information when you visit our website.
                    </p>
                    ...
                    <div style={{ padding: '16px', background: 'rgba(234, 179, 8, 0.1)', borderLeft: '4px solid var(--warning)', borderRadius: '4px', marginBottom: '16px' }}>
                        ...
                        <p style={{ margin: '8px 0 0' }}>
                            VU Academic Hub is a resource sharing platform designed to assist students in their studies. We strictly condemn academic dishonesty. Users act at their own risk when using these resources. We are not officially affiliated with Virtual University of Pakistan.
                        </p>
                    </div>
                    ...
                    <p style={{ marginTop: '8px' }}>📧 <strong>Email:</strong> <a href="mailto:haseebsaleem312@gmail.com" style={{ color: 'var(--primary)', textDecoration: 'underline' }}>haseebsaleem312@gmail.com</a></p>
                </div>
            </div>
        </div>
    );

                        ...
                        return (
                            <div key={s.code} className="card">
                                ...
                                <div className="rating-display" style={{ margin: '8px 0' }}>
                                    <div className="stars">{[1, 2, 3, 4, 5].map(i => <span key={i} className={`star ${s.rating >= i ? 'active' : ''}`}>★</span>)}</div>
                                    <span className="rating-number">{s.rating.toFixed(1)}</span>
                                    <span className="rating-count">({s.totalReviews} reviews)</span>
                                </div>

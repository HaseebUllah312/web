        ...
        <div className="page">
            <div className="container" style={{ maxWidth: '800px' }}>
                ...
                <div className="card" style={{ padding: '32px', lineHeight: '1.8', color: 'var(--text-secondary)' }}>
                    ...
                    <p>By accessing VU Academic Hub, you agree to these terms and conditions. If you do not agree, please do not use our platform.</p>
                    ...
                    <p>If you find any content that violates policies, please report it to <a href="mailto:haseebsaleem312@gmail.com">haseebsaleem312@gmail.com</a>. We will take appropriate action within 24 hours.</p>
                    <h2 style={{ color: 'var(--text-primary)', margin: '24px 0 12px' }}>7. Limitation of Liability</h2>
                    <p>VU Academic Hub and HSM Tech are not liable for any damages arising from the use of this platform. Use at your own discretion.</p>
                </div>
            </div>
        </div>
    );

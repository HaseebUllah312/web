...
export default function AnalyticsPage() {
    ...
    useEffect(() => {
        ...
        setAnalytics({
            dailyRegistrations: [
                { date: '7 days ago', count: 45 },
                { date: '6 days ago', count: 52 },
                { date: '5 days ago', count: 61 },
                { date: '4 days ago', count: 58 },
                { date: '3 days ago', count: 72 },
                { date: '2 days ago', count: 68 },
                { date: 'Today', count: 75 }
            ],
            featureUsage: [
                { feature: 'MCQ Practice', count: 2856 },
                { feature: 'Resource Download', count: 1245 },
                { feature: 'Q&A Forum', count: 892 },
                { feature: 'Quiz Taking', count: 2456 },
                { feature: 'AI Assistant', count: 1124 },
                { feature: 'File Upload', count: 456 }
            ],
            platformMetrics: {
                avgSessionDuration: '22 min',
                serverUptime: '99.9%',
                        ...
                        {analytics.featureUsage.map((feature, idx) => (
                            <div key={idx} style={{ marginBottom: '20px' }}>
                                <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: '8px' }}>
                                    ...
                                    <p style={{ color: 'var(--text-secondary)' }}>{feature.count.toLocaleString()} uses</p>
                                </div>
                                <div style={{
